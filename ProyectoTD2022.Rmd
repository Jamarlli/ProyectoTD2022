...
packages = c("tidyverse","knitr","ggplot2","readr","plotly")
...
Ajuestes que hay que hacer (no se donde meterlos)
```{r}
min(df$Nivel_sonoro) 
max(df$Nivel_sonoro) # No pueden haber registros con un Nivel sonoro infinito
...
# los replazamos por la media del resto de registros
