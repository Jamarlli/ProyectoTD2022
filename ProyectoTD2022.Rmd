...
Para finalizar el estudio vamos a mostrar a las conslusiones que hemos podido 
llegargracias al estudio de los datos recogidos por los sonómetros ubicados en 
Ruzafa. Y esque es curioso la cantidad de informaciçon y conclusiones que puedes 
llegar a sacar dependiendo del enfoque que le des a estos datos.

Por ejemplo, desde el punto de vista de emprendimiento, puedes ver dónde es la 
mejor ubicación de abrir un negocio, ya que podemos relacionar el nivel sonoro 
con la cantidad de personas que afluentan esa zona. En este caso te convendría 
abrirlo en la estación 3, Calle Cádiz, 3.

En cambio si lo ves desde el punto de vista de tu bien estar, no te conviene 
tener tu apartamento en esa estación, sino todo lo contrario, para que no afecte 
ni a tus niveles de concentración ni de sueño. Es decir, te convendría tener el 
apartamento en la estación 14, Calle General Prim Chaflán Donoso Cortés.

Otra de las grandes conclusiones que podemos sacar es la dependencia del Barrio 
Ruzafa de la hostelería y el ocío, ya que los niveles sonoros salen disparados 
los dias de fin de semana, cuando la gente tiene más tiempo libre.
