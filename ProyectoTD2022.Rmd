...
```{r}
cov(dfbiv %>% select("Dia 7-19h", "Tarde 19-23h", "Noche 23-7h", "Dia_tarde_noche", "1min"), method = "pearson")
cov(dfbiv %>% select("Dia 7-19h", "Tarde 19-23h", "Noche 23-7h", "Dia_tarde_noche", "1min"), method = "spearman")
```
...
llegar gracias al estudio de los datos recogidos por los sonómetros ubicados en 
Ruzafa. Llama la atención la cantidad de información y conclusiones que se
pueden llegar a sacar dependiendo del enfoque que se le dé a estos datos.
